...
export const login_User_Google = (dataquery) => {
  return async (dispatch) => {
    try {
      ...
      const responseToken = await axios.post(endpoint, {
...
export function getAllMenusCompany() {
  return async function (dispatch, getState) {
    ...
    const response = await axiosInstance.get(
      `http://localhost:5000/menus/restaurant/${restaurantId}`
    );
    return dispatch({
...
export function getAllMenuitemsCompany() {
  return async function (dispatch, getState) {
    ...
    configureAxios(token);
    const response = await axiosInstance.get(
      `http://localhost:5000/menuitems/restaurant/${restaurantId}`
    );
    return dispatch({
...
export function getAllMenuitemsAdmin() {
  return async function (dispatch, getState) {
    ...
    configureAxios(token);
    const response = await axiosInstance.get(
      `http://localhost:5000/menuitems/all`
    );
    return dispatch({
  ...
  return async function (dispatch, getState) {
    ...
    try {
      const response = await axiosInstance(
        "http://localhost:5000/restaurants/all"
      );
      dispatch({
...
export function getAllUsersAdmin() {
  return async function (dispatch, getState) {
    ...
    try {
      const response = await axiosInstance("http://localhost:5000/users/all");
      dispatch({
        type: GET_USERS_ALL,
        payload: response.data,
      });
...
export function getOrdersAdmin() {
  return async function (dispatch, getState) {
    ...
    try {
      const response = await axiosInstance("http://localhost:5000/orders/all");
      dispatch({
...
export function getAllCategoriesAdmin() {
  return async function (dispatch, getState) {
    ...
    try {
      const response = await axiosInstance(
        `http://localhost:5000/categories/restaurant/${restaurantId}`
      );
      console.log("Categorías obtenidas:", response.data);
      return dispatch({
  ...
  return async (dispatch) => {
    ...
    try {
      ...
      const response = await axios.put(
        `http://localhost:5000/orders/status/${ordenid}`,
        {
          statusorder_id: orderData, // Enviar orderData en el cuerpo de la solicitud
        }
      );
      console.log(
        "Orden actualizada orden completo:",
...
export function getCommentsCompany() {
  return async function (dispatch, getState) {
    ...
    try {
      const response = await axiosInstance(
        `http://localhost:5000/comments/${restaurantId}`
      );
      console.log("Categorías obtenidas:", response.data);
      return dispatch({
...
export const PutComents = (id, isActive) => {
  return async function (dispatch, getState) {
    ...
    try {
      const response = await axiosInstance.put(
        `http://localhost:5000/comments/${id}/status`,
        {
          active: isActive,
        }
      );
