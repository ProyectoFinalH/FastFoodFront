  ...
  return (
    <div className="div-general">
      ...
      <div className="respuesta-carrito-container">
        ...
        {collectionStatus === "approved" ? (
          <div className="login-button-respuesta" onClick={handeComprar}>
            Compra Exitosa ahora continua comprando
          </div>
        ) : (
          <div className="negate-div">
            <label>
              El estado de la compra no fue aprovado ahora continua con tu
              proceso ya que todo esta guadado en tu carrito
            </label>
            <div className="btn-reprovado" onClick={handeRegresar}>
              {" "}
              clic para continuar{" "}
            </div>
          </div>
